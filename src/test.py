...
import transformers
from MyTrainer.trainer import Trainer
from dataclasses import dataclass, field
from FusionMed_data.multi_dataset_test import multi_dataset
from Model.FusionMed.multimodality_model import MultiLLaMAForCausalLM
...
class ModelArguments:
    lang_encoder_path: Optional[str] = field(default="/home/hekang/Project/FusionMed/src/Model/checkpoint-text")
    tokenizer_path: str = field(default='/home/hekang/Project/FusionMed/src/Model/LLAMA_Model/tokenizer', metadata={"help": "Path to the tokenizer data."})   
...
class TrainingArguments(transformers.TrainingArguments):
    ...
    output_dir: Optional[str] = field(default="/home/hekang/Project/FusionMed/src/Results/text_output")
...
def main():
    ...
    ckpt = torch.load('/home/hekang/Project/FusionMed/src/Results/best_checkpoint/pytorch_model.bin',map_location ='cpu')
