...
if __name__ == "__main__":
    ...
    image_root_dir = '/mnt/third/hekang/DATA/Radio_VQA/processed_file/images'
    json_root_dir = '/mnt/third/hekang/DATA/Radio_VQA/processed_file/jsons'
    save_root_dir = '/mnt/third/hekang/DATA/Radio_VQA/processed_file/npys'
    save_case_dict = []
    ...
    # save to csv
    save_json_file = '/mnt/third/hekang/DATA/Radio_VQA/processed_file/processed_jsons/processed_json_'+str(args.index)+'.json'
