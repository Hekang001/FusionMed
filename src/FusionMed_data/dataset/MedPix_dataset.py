...
class MedPix_Single_Dataset(Dataset):
    def __init__(self, csv_path, img_root = "/home/hekang/Project/FusionMed/scr/FusionMed_data/MedPix/images/",down_sample_ratio = 5):
...
class MedPix_Multi_Dataset(Dataset):
    def __init__(self, csv_path, img_root = "/home/hekang/Project/FusionMed/scr/FusionMed_data/MedPix/images/"):
        self.case_list = pd.read_csv(csv_path)
        self.img_root = img_root
        #normalize = transforms.Normalize((0.485, 0.456, 0.406), (0.229, 0.224, 0.225))
        self.transform = transforms.Compose([                        
