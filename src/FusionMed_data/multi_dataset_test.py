...
class multi_dataset(Dataset):
    def __init__(self, text_tokenizer, test_split = 'close', max_seq = 2048, max_img_size = 10, image_num=32,voc_size =32000):
        ...
        if self.test_split == 'diagnosis':
            chestxray_dataset_bn = Binary_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/chestxray_balance_test.csv',  
            ...
            pcxr_dataset_bn = Binary_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/pcxr_balance_test.csv',  
                                        prompt_json_file = '/home/hekang/Project/FusionMed/src/FusionMed_data/dataset/yes_no_prompt.json')
            ...
            mammo_dataset_bn = Binary_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/mammo_balance_test.csv',  
                                        prompt_json_file = '/home/hekang/Project/FusionMed/src/FusionMed_data/dataset/yes_no_prompt.json')
            ...
            spinexr_dataset_bn = Binary_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/spinexr_balance_test.csv',  
                                        prompt_json_file = '/home/hekang/Project/FusionMed/src/FusionMed_data/dataset/yes_no_prompt.json')
            ...
            ### multi-label ###
            chestxray_dataset = ChestXray_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/chestxray_test.csv',  
            ...
            pcxr_dataset = ChestXray_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/pcxr_test.csv',  
                                prompt_json_file = '/home/hekang/Project/FusionMed/src/FusionMed_data/dataset/cls_prompt.json')
            ...
            mammo_dataset = ChestXray_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/mammo_test.csv',  
            ...
            spinexr_dataset = ChestXray_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/spinexr_test.csv',  
        ...
        if self.test_split == 'modality':
            radiomodality_dataset = Radio_Modality_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/radio_modality_test.csv',  
                                prompt_json_file = '/home/hekang/Project/FusionMed/src/FusionMed_data/dataset/modality_prompt.json',
                                modality_json_file = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/modality_set.json',down_sample_ratio = 1)
        ...
        if self.test_split == 'vqa':
            ...
            pmcvqa_dataset = VQA_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/pmcvqa_test.csv')
            ...
            casereport_dataset = CaseReport_dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/filtered_case_report_test.csv',    
            ...
            vqarad_dataset = VQA_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/vqarad_test.csv')
            ...
            slake_dataset = VQA_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/slakevqa_test.csv')
            ...
            ## 3D
            radiovqa_dataset = RadioVQA_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/radiology_vqa_test.csv')
        ...
        if self.test_split == 'caption':
            ...
            chestxray_caption_dataset = ChestXray_Dataset(csv_path = '/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/mimic_caption_test.csv',  
            ...
            radiocaption_dataset = RadioCaption_Dataset(json_path='/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/radiology_article_npy_test.json',
        ...
        if self.test_split == 'feature':    
            radiofeatures_dataset = Radiofeatures_Dataset(json_path='/home/hekang/Project/FusionMed/src/FusionMed_data/data_csv/radiology_article_npy_test.json',
